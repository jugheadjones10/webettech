...
over the other? What are the pros and cons of each?<br/><br/>
...
stack overflow thread contains other practical reasons for access modifiers.<br/><br/>

Java, unlike C languages, have a garbage collector that doesn't necessitate manual
memory management.