---
title: 23rd Jan - School
date: 2020-01-23
tags:
  - School
---
CS2030S - got introduced to the concepts of static and dynamic typing. Why one
over the other? What are the pros and cons of each?

Let's address the reasons for access variables (private, public) once and for all.
...
square root calculations itself. So instead of **asking** for values and doing the 
work yourself, classes should **tell** each other what to do in their own classes.

This brings up a crucial point. Let's say I changed the implementation of Point
like so :
...
Getters are also part of the solution. As long as I write my Getters
to properly clean or transform my class fields for the outside world to access,
dependencies on my class will not break no matter the implementation.

Getters ensure that even if some classes are not following "Tell Don't Ask", 
they won't break when implementation changes.
